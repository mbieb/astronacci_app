...
class _$ForgotPasswordFormImpl extends _ForgotPasswordForm {
  const _$ForgotPasswordFormImpl({required this.email}) : super._();
...
abstract class _ForgotPasswordForm extends ForgotPasswordForm {
  const factory _ForgotPasswordForm({required final EmailAddress email}) =
